...
var client = {
	...
	displayResults: function(age, value, gender, gendervalue, ethnicity, ethnicityvalue) {
		...
		$("#agecertainty").text("Certainty: ").append(parseFloat(value).toFixed(2)*100 + "%");
		...
		$("#gendercertainty").text("Certainty: ").append(parseFloat(gendervalue).toFixed(2)*100 + "%");
		...
		$("#ethnicitycertainty").text("Certainty: ").append(parseFloat(ethnicityvalue).toFixed(2)*100 + "%");
